...
pipeline {
  ...
  parameters {
    string(name: 'hugo_version', defaultValue: '0.57.0', description: 'The Hugo version that will be used to build the website. Must match versions speficied on https://github.com/gohugoio/hugo/releases.')
